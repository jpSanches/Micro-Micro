...
```
Testa-se com apenas um TJB

Ic = B*Ib 4 = 100*Ib Ib = 40 mA

Não é possível utilizar somente 1 TJB. Usa-se o Par Darlington.

Ic = Ib*B**2 4 = Ib*100**2 Ib = 0.4 mA
...
Ic = B*Ib 1 = 120*Ib Ib = 8.33 mA

OK. Seguem os cáculos
...
void Multi_displays()
{
	...
	for(int i = 0; i <= 9; i++){
		P2OUT = DISP1; // aciona cátodo comum do display 1
		EscreveDigito((char) ('0'+i));
		Atraso(10);

		P2OUT = DISP2; // aciona cátodo comum do display 2
		EscreveDigito((char) ('0'+i));
		Atraso(10);
	}
